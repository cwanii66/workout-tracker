<template>
<!-- max-w-screen-md ==> restrict this div from getting no longer than the breakpoint of medium that tailwinds defines -->
  <div class="max-w-screen-md mx-auto px-4 py-10">
    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
      ...
      <form @submit.prevent="createWorkout" class="flex flex-col gap-y-5 w-full">
        ...
        <!-- Workout Type -->
        <div class="flex flex-col">
          <label for="workout-name" class="mb-1 text-sm-text-at-light-green">Workout Type</label>
